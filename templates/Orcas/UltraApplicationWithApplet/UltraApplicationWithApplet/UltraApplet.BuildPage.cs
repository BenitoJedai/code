		...
		public void BuildPage(PHTMLElement that)
		{
			...
			that.get_ownerDocument(
				doc =>
				{
					...
					StringAction CreateColorButton =
						Color =>
						{
