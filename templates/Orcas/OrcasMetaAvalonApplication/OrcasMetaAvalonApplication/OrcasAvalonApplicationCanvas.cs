...
namespace OrcasMetaAvalonApplication.Shared
{
	...
	public class OrcasAvalonApplicationCanvas : Canvas
	{
		...
		public OrcasAvalonApplicationCanvas()
		{
			...
			var img = new Image
			{
				Source = ("assets/OrcasMetaAvalonApplication/jsc.png").ToSource()
...
",
			...
			var sand = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/OrcasMetaAvalonApplication/sand.png".ToSource()
			}.AttachTo(this);
			...
			var tri = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/OrcasMetaAvalonApplication/17.png".ToSource()
			}.AttachTo(this);
			...
			var trig = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/OrcasMetaAvalonApplication/17g.png".ToSource()
			}.AttachTo(this);
