namespace OrcasMetaWindowsForms
{
	partial class Form1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.localMyPanel1 = new OrcasMetaWindowsForms.MyContext.LocalMyPanel();
			this.SuspendLayout();
			// 
			// label1
			// 
		...
		private OrcasMetaWindowsForms.MyContext.LocalMyPanel localMyPanel1;
	}
}
