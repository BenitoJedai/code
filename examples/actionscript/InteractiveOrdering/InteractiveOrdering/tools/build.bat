...
@call :mxmlc %1/ActionScript InteractiveOrderingFlash
...
start /WAIT C:\util\flex_sdk_4.0.0.14159\bin\mxmlc.exe -debug -keep-as3-metadata -incremental=true -output=%2.swf -strict -sp=. %1/%2.as
goto :eof