...
namespace Screencast20091001.Shared
{
	...
	public class OrcasAvalonApplicationCanvas : Canvas
	{
		...
		public OrcasAvalonApplicationCanvas()
		{
			...
			var img = new Image
			{
				Source = ("assets/Screencast20091001/jsc.png").ToSource()
...
",
			...
			var sand = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/Screencast20091001/sand.png".ToSource()
			}.AttachTo(this);
			...
			var tri = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/Screencast20091001/17.png".ToSource()
			}.AttachTo(this);
			...
			var trig = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/Screencast20091001/17g.png".ToSource()
			}.AttachTo(this);
