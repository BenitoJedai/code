...
namespace TheCloudEffect.ActionScript
{
	...
	public class TheCloudEffect : Sprite
	{
		...
		private int _perlinNoiseSizeW = Convert.ToInt32(DefaultWidth * _perlinNoiseSize);
		private int _perlinNoiseSizeH = Convert.ToInt32(DefaultHeight * _perlinNoiseSize * _H_RATE);
		...
		private Rectangle _rect = new Rectangle(0, 0, DefaultWidth, DefaultHeight);
