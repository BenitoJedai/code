...
using FlashHeatZeeker.UnitJeepSync.Library;
...
namespace FlashHeatZeeker.UnitJeepSync
{
    ...
    public sealed class ApplicationSprite : Sprite
    {
        ...
        public void __transport_in(string xmlstring)
        {
            ...
            {
                StarlingGameSpriteWithJeepSync.__at_sync(
            ...
            {
                StarlingGameSpriteWithJeepSync.__at_SetVelocityFromInput(
        ...
        public ApplicationSprite()
        {
            ...
            StarlingGameSpriteWithJeepSync.__raise_SetVelocityFromInput +=
                (
                    string __egoid,
                    string __identity,
                    string __KeySample,
