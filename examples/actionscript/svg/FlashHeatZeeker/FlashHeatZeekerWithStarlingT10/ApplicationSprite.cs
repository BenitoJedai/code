...
using System.IO;
using System.Text;
using FlashHeatZeekerWithStarlingT10.ActionScript.Images;
...
using FlashHeatZeekerWithStarlingT10.Library;

namespace FlashHeatZeekerWithStarlingT10
{
    static class X
    {
    ...
    class GameMap
    {
        ...
        public GameMap()
        {
            ...
            //at FlashHeatZeekerWithStarlingT10::GameMap()[T:\web\FlashHeatZeekerWithStarlingT10\GameMap.as:33]
            //at FlashHeatZeekerWithStarlingT10::Game()[T:\web\FlashHeatZeekerWithStarlingT10\Game.as:181]
    ...
    public class Game : Sprite
    {
        ...
        public Game()
        {
            ...
            var textures_road0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/road0.svg");
            var textures_touchdown = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/touchdown.svg");
            ...
            var textures_hill0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/hill0.svg");
            ...
            var textures_hill1 = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/hill1.svg");
            ...
            var textures_watertower0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/watertower0.svg");

            var textures_tree0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/tree0.svg");
            var textures_tree0_shadow = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/tree0_shadow.svg");
            ...
            var textures_tanktrackpattern = new_tex_512("assets/FlashHeatZeekerWithStarlingT10/tanktrackpattern.svg");
            ...
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterB.svg", mapB.Location.x, mapB.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterC.svg", mapC.Location.x, mapC.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterD.svg", mapD.Location.x, mapD.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterE.svg", mapE.Location.x, mapE.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterF.svg", mapF.Location.x, mapF.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT10/letterG.svg", mapG.Location.x, mapG.Location.y);



            textures_tanktrackpattern.repeat = true;

            var textures_bullet = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/bullet.svg");
            var textures_tracks0 = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/tracks0.svg");

            var textures_jeep = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/jeep.svg");
            var textures_jeep_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/jeep_shadow.svg");
            var textures_jeep_trackpattern = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/jeep_trackpattern.svg");

            var textures_ped_stand = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/ped_stand.svg");

            var textures_greentank = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/greentank.svg");
            var textures_greentank_guntower = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/greentank_guntower.svg");
            var textures_greentank_guntower_rank = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/greentank_guntower_rank.svg");
            var textures_greentank_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/greentank_shadow.svg");

            //R:\web\FlashHeatZeekerWithStarlingT10\ApplicationSprite.as(796): col: 9: Error: exception during transcoding: null
            //Enclosed Exception:
            //Invalid byte 1 of 1-byte UTF-8 sequence.

            var textures_hind0_wing1 = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/hind0_wing1.svg");
            var textures_hind0_nowings = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/hind0_nowings.svg");
            var textures_hind0_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT10/hind0_shadow.svg");
           ...
           delegate
           {
            ...
            Action F1 = delegate
            {
                ...
                //FlashHeatZeekerWithStarlingT10.Game+<>c__DisplayClass22.<.ctor>b__19 at offset 035c.
            ...
            Action<GameUnit> switchto =
                nextunit =>
                {
                    KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT10/letsgo.mp3"].ToSoundAsset().play();
            ...
            ApplicationSprite.__stage.keyUp +=
              e =>
              {
                  ...
                  {
                      //                      System.Linq.Enumerable for System.Collections.Generic.IEnumerable`1[FlashHeatZeekerWithStarlingT10.GameUnit] Skip[GameUnit](System.Collections.Generic.IEnumerable`1[FlashHeatZeekerWithStarlingT10.GameUnit], Int32) used at
                      //FlashHeatZeekerWithStarlingT10.Game+<>c__DisplayClass10.<.ctor>b__a at offset 014b.
                      //If the use of this method is intended, an implementation should be provided with the attribute [Script(Implements=typeof(...)] set. You may have mistyped it.
                  ...
                  if (e.keyCode == (uint)System.Windows.Forms.Keys.ControlKey)
                  {
                      ...
                      KineticEnergy.Add(
                          new FlashHeatZeekerWithStarlingT10.KineticEnergy
                          {
                              Target = unit_bullet,
                              Energy = new __vec2(
                  ...
                  if (e.keyCode == (uint)System.Windows.Forms.Keys.Space)
                  {
                      ...
                      {
                          // touchdown!
                          KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT10/snd_touchdown.mp3"].ToSoundAsset().play();
