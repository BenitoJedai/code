...
set e=%cd%
set swf=FlashHeatZeeker.TestGamePad.ApplicationSprite.swf
set apk=air.com.abstractatech.gamification.fhzpad.apk
set xml=air.com.abstractatech.gamification.fhzpad.xml
