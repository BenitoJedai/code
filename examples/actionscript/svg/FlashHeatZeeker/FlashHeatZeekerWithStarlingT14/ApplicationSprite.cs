...
using System.IO;
using System.Text;
using FlashHeatZeekerWithStarlingT14.ActionScript.Images;
...
using FlashHeatZeekerWithStarlingT14.Library;
...
namespace FlashHeatZeekerWithStarlingT14
{
    ...
    class GameMap
    {
        ...
        public GameMap()
        {
            ...
            //at FlashHeatZeekerWithStarlingT14::GameMap()[T:\web\FlashHeatZeekerWithStarlingT14\GameMap.as:33]
            //at FlashHeatZeekerWithStarlingT14::Game()[T:\web\FlashHeatZeekerWithStarlingT14\Game.as:181]
    ...
    public class Game : Sprite
    {
        ...
        public Game()
        {
            ...
            var textures_road0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/road0.svg");
            var textures_touchdown = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/touchdown.svg");
            ...
            var textures_hill0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/hill0.svg");
            ...
            var textures_hill1 = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/hill1.svg");
            ...
            var textures_watertower0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/watertower0.svg");

            var textures_tree0 = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/tree0.svg");
            var textures_tree0_shadow = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/tree0_shadow.svg");
            ...
            var textures_tanktrackpattern = new_tex_512("assets/FlashHeatZeekerWithStarlingT14/tanktrackpattern.svg");
            ...
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterB.svg", mapB.Location.x, mapB.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterC.svg", mapC.Location.x, mapC.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterD.svg", mapD.Location.x, mapD.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterE.svg", mapE.Location.x, mapE.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterF.svg", mapF.Location.x, mapF.Location.y);
            pin_letter("assets/FlashHeatZeekerWithStarlingT14/letterG.svg", mapG.Location.x, mapG.Location.y);



            textures_tanktrackpattern.repeat = true;

            var textures_bullet = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/bullet.svg");
            var textures_tracks0 = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/tracks0.svg");

            var textures_jeep = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/jeep.svg");
            var textures_jeep_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/jeep_shadow.svg");
            var textures_jeep_trackpattern = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/jeep_trackpattern.svg");

            var textures_ped_stand = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/ped_stand.svg");

            var textures_greentank = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/greentank.svg");
            var textures_greentank_guntower = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/greentank_guntower.svg");
            var textures_greentank_guntower_rank = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/greentank_guntower_rank.svg");
            var textures_greentank_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/greentank_shadow.svg");

            var textures_hind0_wing1 = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/hind0_wing1.svg");
            var textures_hind0_nowings = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/hind0_nowings.svg");
            var textures_hind0_shadow = new_tex_400("assets/FlashHeatZeekerWithStarlingT14/hind0_shadow.svg");
           ...
           delegate
           {
            ...
            var helicopter1 = KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/helicopter1.mp3"].ToSoundAsset().ToMP3PitchLoop();
            var diesel2 = KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/diesel4.mp3"].ToSoundAsset().ToMP3PitchLoop();
            var sand_run = KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/sand_run.mp3"].ToSoundAsset().ToMP3PitchLoop();
            var jeepengine = KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/jeepengine.mp3"].ToSoundAsset().ToMP3PitchLoop();
            ...
            ApplicationSprite.__stage.enterFrame +=
                delegate
                {
                    ...
                    //    at FlashHeatZeekerWithStarlingT14::Game___c__DisplayClass46/__ctor_b__3b_100663971()[V:\web\FlashHeatZeekerWithStarlingT14\Game___c__DisplayClass46.as:163]
            ...
            Action<GameUnit> switchto =
                nextunit =>
                {
                    KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/letsgo.mp3"].ToSoundAsset().play();
            ...
            ApplicationSprite.__stage.keyUp +=
              e =>
              {
                  ...
                  {
                      //                      System.Linq.Enumerable for System.Collections.Generic.IEnumerable`1[FlashHeatZeekerWithStarlingT14.GameUnit] Skip[GameUnit](System.Collections.Generic.IEnumerable`1[FlashHeatZeekerWithStarlingT14.GameUnit], Int32) used at
                      //FlashHeatZeekerWithStarlingT14.Game+<>c__DisplayClass10.<.ctor>b__a at offset 014b.
                  ...
                  if (e.keyCode == (uint)System.Windows.Forms.Keys.ControlKey)
                  {
                      ...
                      KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/cannon1.mp3"].ToSoundAsset().play();
                      ...
                      KineticEnergy.Add(
                          new FlashHeatZeekerWithStarlingT14.KineticEnergy
                          {
                              Target = unit_bullet,
                              Energy = new __vec2(
                  ...
                  if (e.keyCode == (uint)System.Windows.Forms.Keys.Space)
                  {
                      ...
                      {
                          // touchdown!
                          KnownEmbeddedResources.Default["assets/FlashHeatZeekerWithStarlingT14/snd_touchdown.mp3"].ToSoundAsset().play();
                  ...
                  if (e.keyCode == (uint)System.Windows.Forms.Keys.F1)
                  {
                      ...
                      //FlashHeatZeekerWithStarlingT14.Game+<>c__DisplayClass22.<.ctor>b__19 at offset 035c.
                      //If the use of this method is intended, an implementation should be provided with the attribute [Script(Implements=typeof(...)] set. You may have mistyped it.
