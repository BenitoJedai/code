using FlashHeatZeeker.Lobby.Design;
using FlashHeatZeeker.Lobby.HTML.Pages;
using ScriptCoreLib;
...
namespace FlashHeatZeeker.Lobby
{
    ...
    public static class XX
    {
        ...
        public static void wmode(this ScriptCoreLib.ActionScript.flash.display.Sprite s, string value = "direct")
        {
