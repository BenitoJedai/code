...
namespace System_Windows_Media_Imaging_BitmapImage.ActionScript
{
	using TargetCanvas = global::System_Windows_Media_Imaging_BitmapImage.Shared.OrcasAvalonApplicationCanvas;
