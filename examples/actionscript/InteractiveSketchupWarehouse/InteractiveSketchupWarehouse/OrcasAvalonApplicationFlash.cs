...
namespace InteractiveSketchupWarehouse.ActionScript
{
	using TargetCanvas = global::InteractiveSketchupWarehouse.Shared.InteractiveSketchupWarehouseCanvas;
	...
	public class OrcasAvalonApplicationFlash : Sprite
	{
		public OrcasAvalonApplicationFlash()
		{
			...
			Security.loadPolicyFile("http://sketchup.google.com/crossdomain.xml");
