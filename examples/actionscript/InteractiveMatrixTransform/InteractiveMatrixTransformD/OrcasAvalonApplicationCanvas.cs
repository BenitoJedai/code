...
namespace InteractiveMatrixTransformD.Shared
{
	[Script]
...
",
			...
			var sand = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/InteractiveMatrixTransformD/sand.png".ToSource()
			}.AttachTo(this);
			...
			var tri = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/InteractiveMatrixTransformD/17.png".ToSource()
			}.AttachTo(this);
			...
			var trig = new Image
			{
				Width = 100,
				Height = 100,
				Source = "assets/InteractiveMatrixTransformD/17g.png".ToSource()
			}.AttachTo(this);
