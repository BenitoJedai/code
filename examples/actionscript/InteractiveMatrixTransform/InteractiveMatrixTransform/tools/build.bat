...
start /WAIT C:\util\flex_sdk_4.6\bin\mxmlc.exe -static-link-runtime-shared-libraries=true  -keep-as3-metadata -incremental=true -output=%2.swf -strict -sp=. %1/%2.as
goto :eof