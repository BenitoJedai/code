package  
{
	 ...
	 * @author Ariel Nehmad
	 */
	public class Step05_TheShip extends Sprite 
	{
		...
		public function Step05_TheShip() 
		{
			...
			oceanShader.params.skyMap.value = new Texture3D( "assets/Flare3DWaterStep5TheShip/highlights.png", false, Texture3D.FORMAT_CUBEMAP );
			oceanShader.params.normalMap.value = new Texture3D( "assets/Flare3DWaterStep5TheShip/normalMap.jpg" );
			oceanShader.params.mirrorMap.value = mirror;
			
			water = new Plane( "water", 3000, 3000, oceanGridSize - 1, oceanShader, "+xz" );			
			skybox = new SkyBox( "assets/Flare3DWaterStep5TheShip/skybox.png", SkyBox.HORIZONTAL_CROSS, null, 1 );
			ship = new Flare3DLoader( "assets/Flare3DWaterStep5TheShip/ship.zf3d" );
			ship.load();
		...
		private function renderEvent(e:Event):void 
		{
			...
			ship.rotateX( Math.cos( t / 400 ) * 6 );
			ship.rotateZ( Math.cos( t / 300 ) * 6 );
