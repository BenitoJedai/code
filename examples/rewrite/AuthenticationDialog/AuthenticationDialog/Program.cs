...
namespace AuthenticationDialog
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var r = Authentication.PromptForPassword(
                "my.jsc-solutions.net " + "(" + Environment.MachineName + ")",
            ...
            Console.WriteLine(new { r, save, user, password });
...
internal static class Authentication
{
    ...
    internal static bool PromptForPassword(
        string targetName,
        out string user, out string password, ref bool save)
    {
