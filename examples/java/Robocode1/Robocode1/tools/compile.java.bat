...
%TargetPath% -classpath "%TargetSourceFiles%;C:\util\robocode\libs\robocode.jar" -d release java\%CompilandNamespace0%\%CompilandType%.java java\%CompilandNamespace0%\Kenny1.java
