...
using EntryPointProgram = MazeConsole.source.java.Program;
using EntryPointSettings = MazeConsole.source.java.Settings;
...
[assembly:
	...
	ScriptNamespaceRename(
		NativeNamespaceName = "MazeConsole.source.java",
