namespace SimpleForms2.MyContext
{
	partial class LocalMyPanel
	{
		...
		{
			this.localInformation1 = new SimpleForms2.MyContext.LocalInformation();
			this.localLocation1 = new SimpleForms2.MyContext.LocalLocation();
			this.SuspendLayout();
			// 
			// TextBoxComment
			// 
