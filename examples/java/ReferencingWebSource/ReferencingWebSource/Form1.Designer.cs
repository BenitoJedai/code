namespace ReferencingWebSource
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.localMyPanel1 = new ReferencingWebSource.MyContext.LocalMyPanel();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.Name = "Form1";
			this.Text = "ReferencingWebSource. Your C# will be converted javascript and java.";
		...
		private ReferencingWebSource.MyContext.LocalMyPanel localMyPanel1;
	}
}
