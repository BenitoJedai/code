...
namespace DelaunayExample.Java
{
	...
	public class Pnt
	{
		...
		public Pnt(double[] coords)
		{
			...
			global::System.Array.Copy(coords, 0, coordinates, 0, coords.Length);
		}
		...
		public Pnt(double coordA, double coordB)
			: this(ToDoubleArray(coordA, coordB))
		{

		}

		static double[] ToDoubleArray(double a, double b)
		{
		...
		public Pnt(double coordA, double coordB, double coordC)
			: this(ToDoubleArray(coordA, coordB, coordC))
		{

		}

		static double[] ToDoubleArray(double a, double b, double c)
		{
		...
		public int hashCode()
		{
			...
			for (int i = 0; i < this.coordinates.Length; i++)
			{
				long bits = BitConverter.DoubleToInt64Bits(this.coordinates[i]);
		...
		public Pnt extend(double[] coords)
		{
			...
			global::System.Array.Copy(coordinates, 0, result, 0, coordinates.Length);
			global::System.Array.Copy(coords, 0, result, coordinates.Length, coords.Length);
