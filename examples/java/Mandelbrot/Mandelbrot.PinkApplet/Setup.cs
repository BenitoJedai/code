...
namespace Mandelbrot.PinkApplet
{
	...
	class Setup
	{
		...
		public static void DefineEntryPoint(IEntryPoint e)
		{
			...
			{
				ProjectName = typeof(MandelbrotApplet).Name,
				CompilandNamespace0 = typeof(MandelbrotApplet).Namespace.Replace(".", "/"),
				CompilandNamespace1 = typeof(MandelbrotApplet).Namespace,
				AppletWebPage = typeof(MandelbrotApplet).Name + ".htm",
				CompilandType = typeof(MandelbrotApplet).Name,
				CompilandFullName = typeof(MandelbrotApplet).Namespace + "." + typeof(MandelbrotApplet).Name,
				PackageName = typeof(MandelbrotApplet).Name + "Package.jar",
			};
