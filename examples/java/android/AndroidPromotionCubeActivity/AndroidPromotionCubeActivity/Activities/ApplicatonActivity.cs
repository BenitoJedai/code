...
using AndroidPromotionCubeActivity.Library;
using java.lang;
using java.nio;
...
namespace AndroidPromotionCubeActivity.Activities
{
    using opengl = GLES20;
    using gl = __WebGLRenderingContext;


    public class AndroidPromotionCubeActivity : Activity
    {
        ...
        // C:\util\android-sdk-windows\tools\android.bat create project --package AndroidPromotionCubeActivity.Activities --activity AndroidPromotionCubeActivity  --target 2  --path y:\jsc.svn\examples\java\android\AndroidPromotionCubeActivity\AndroidPromotionCubeActivity\staging
        ...
        // "C:\util\android-sdk-windows\platform-tools\adb.exe" install -r "y:\jsc.svn\examples\java\android\AndroidPromotionCubeActivity\AndroidPromotionCubeActivity\staging\bin\AndroidPromotionCubeActivity-debug.apk"
