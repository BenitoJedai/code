...
using AndroidVortexLesson4.Library;
using java.lang;
using java.nio;
...
namespace AndroidVortexLesson4.Activities
{
    // A package name must be constitued of two Java identifiers.

    [Script]
    public class AndroidVortexLesson4 : Activity
    {
        // port from http://www.droidnova.com/android-3d-game-tutorial-part-iv,358.html

        // C:\util\android-sdk-windows\tools\android.bat create project --package AndroidVortexLesson4.Activities --activity AndroidVortexLesson4  --target 2  --path Z:\jsc.svn\examples\java\android\AndroidVortexLesson4\AndroidVortexLesson4\staging

        // http://developer.android.com/guide/developing/device.html#setting-up

        // running it in emulator:
        // C:\util\android-sdk-windows\tools\android.bat avd
        // "C:\util\android-sdk-windows\platform-tools\adb.exe" install -r "Z:\jsc.svn\examples\java\android\AndroidVortexLesson4\AndroidVortexLesson4\staging\bin\AndroidVortexLesson4-debug.apk"
