    ...
    public partial class RayCaster1Base : Applet, Runnable
    {
        ...
        public void createTables()
        {
            ...
            for (i = 0; i <= ANGLE360; i++)
            {
                ...
                fSinTable[i] = (double)System.Math.Sin(radian);
                fISinTable[i] = (1.0F / (fSinTable[i]));
                fCosTable[i] = (double)System.Math.Cos(radian);
                fICosTable[i] = (1.0F / (fCosTable[i]));
                fTanTable[i] = (double)System.Math.Tan(radian);
            ...
            for (i = -ANGLE30; i <= ANGLE30; i++)
            {
                ...
                fFishTable[i + ANGLE30] = (double)(1.0F / System.Math.Cos(radian));
            }
