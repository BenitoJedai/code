...
namespace HistoryStatesViaWebService
{
    ...
    public class ApplicationWebService
    {
        ...
        public async Task<ApplicationWebService> DoEnter()
        {
            return new ApplicationWebService
            {
                state = new ApplicationState { title = "you have now entered a new state" }
            };
        }

        public string reason;

        public async Task<ApplicationWebService> DoEnterData(
            ...
            )
        {
            ...
            return new ApplicationWebService
            {
                ...
                {
                    title = "you are now looking at data",
                    data = table
                }
            };
        }
