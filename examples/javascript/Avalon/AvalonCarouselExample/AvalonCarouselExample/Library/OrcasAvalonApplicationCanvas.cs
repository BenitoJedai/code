        ...
        public OrcasAvalonApplicationCanvas()
        {
            ...
            Action<ImageSource, double, Uri> AddEntry =
                (Source, u, Target) =>
                {
                    ...
                    var p = new AvalonCarouselExample.Avalon.Images.PreviewShadow
                    {
                        Width = 166,
                        Height = 90,
                    ...
                    var ps = new AvalonCarouselExample.Avalon.Images.PreviewSelection
                    {
                        Width = 138,
                        Height = 108,
                        Stretch = Stretch.Fill,
            ...
            10.Times(
                ...
                {
                    AddEntry(
                        new AvalonCarouselExample.Avalon.Images.AvalonGalleryExample().Source,
                        Math.PI / 5 * i,
