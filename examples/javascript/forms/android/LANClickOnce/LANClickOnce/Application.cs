using LANClickOnce.Design;
using LANClickOnce.HTML.Pages;
using ScriptCoreLib;
...
namespace LANClickOnce
{
    ...
    public sealed class Application
    {
        ...
        //+ Downloading http://127.0.0.1:8080/LANClickOnceClient.application did not succeed.
        //+ Unable to connect to the remote server
        //+ No connection could be made because the target machine actively refused it 127.0.0.1:8080
        //An error occurred trying to download 'http://127.0.0.1:8080/LANClickOnceClient.application'.
        // - The digital signature of the object did not verify.

        static LANClickOnce.Assets.Publish ref0;
    ...
    public static class DownloadSDKFunction
    {
        public static void DownloadSDK(WebServiceHandler h)
        {
            ...
            if (path == "/download")
            {
                h.Context.Response.Redirect("/download/LANClickOnceClient.application");
                h.CompleteRequest();
                return;
            }
...
<div><i>Note that recent versions of <b>Google Chrome</b> may need additional time to verify.</i></div>                  
            ...
            var p = new LANClickOnce.Assets.Publish();
