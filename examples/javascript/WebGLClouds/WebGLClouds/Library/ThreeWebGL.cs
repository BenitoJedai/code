...
namespace WebGLClouds.Library.THREE
{
    ...
    [Script(HasNoPrototype = true, ExternalTarget = "Texture")]
    class Texture
    {
    ...
    [Script(HasNoPrototype = true, ExternalTarget = "THREE.Geometry")]
    class Geometry
    {
    ...
    sealed class WebGLRendererArguments
    {
    ...
    class WebGLRenderer
    {
        ...
        public WebGLRenderer(WebGLRendererArguments e)
        {
    ...
    sealed class MeshShaderMaterialArguments39
    {
    ...
    class MeshShaderMaterial
    {
        ...
        public MeshShaderMaterial(object value)
        {
    ...
    class Mesh
    {
        ...
        public Mesh(object value, object x = null)
        {
