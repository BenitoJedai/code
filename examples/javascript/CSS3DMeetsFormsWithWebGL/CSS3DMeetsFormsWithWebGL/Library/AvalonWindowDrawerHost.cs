...
{
    public class AvalonWindowDrawerHost : System.Windows.Forms.UserControl
    {
        ...
        public AvalonWindowDrawerHost()
        {
            ...
            this.Load +=
                delegate
                {
                    ...
                    if (Child == null)
                        Child = new AvalonWindowDrawer.ApplicationCanvas();
