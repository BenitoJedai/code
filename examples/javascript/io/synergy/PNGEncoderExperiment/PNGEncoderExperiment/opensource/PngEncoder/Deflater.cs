    ...
    public class Deflater
    {
		...
		*/
        ...
        public int Deflate(byte[] output, int offset, int length)
        {
            ...
            // X:\jsc.svn\examples\javascript\Test\TestEmptyForLoop\TestEmptyForLoop\Application.cs
            var ok = true;
            ...
            while (ok)
            {
                ...
                var flag13 = length == 0 || state == FINISHED_STATE;
                if (flag13)
                {
                    ok = false;
                    // break
                ...
                else
                {
                    ...
                    var flag1 = !engine.Deflate((state & IS_FLUSHING) != 0, (state & IS_FINISHING) != 0);
                    if (flag1)
                    {
                        if (state == BUSY_STATE)
                        {
