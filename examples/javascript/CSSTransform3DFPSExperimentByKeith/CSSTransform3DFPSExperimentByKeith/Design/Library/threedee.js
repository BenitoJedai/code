...
// rug
world.addPlane(new Plane("url(assets/CSSTransform3DFPSExperimentByKeith/rug.jpg)", 200, 340, 100, -170, 52, 0, 180, 0));

// table
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 100, -50, -100, -49);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 100, 50, -100, -49);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 100, -50, 100, -49);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 100, 50, 100, -49);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 130, 250, 15, -60, -120, -65);

// chair
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 55, 135, -30, -4);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 55, 135, 30, -4);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 55, 75, -30, -4);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 10, 55, 75, 30, -4);
...
var __osxPlane = new Plane("url(assets/CSSTransform3DFPSExperimentByKeith/osx.jpg)", 110, 65, -19, -55, -165, 90, 90, 0);
...
// keyboard
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/mac-keybd.png)", 31, 70, 1, 10, -35, -67);

// mouse
buildCube("#eee", 20, 12, 2, 20, 60, -69);

// bookshelf
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 50, 300, -350, 345, -250);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 10, 50, 300, -150, 345, -250);
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 190, 50, 10, -340, 345, -250); // shelf
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 190, 50, 10, -340, 345, -160); // shelf
buildCube("url(assets/CSSTransform3DFPSExperimentByKeith/desk.jpg)", 190, 50, 10, -340, 345, -65); // shelf
