        ...
        public Application(IApp page)
        {
            ...
            Action<HistoryScope<InternalScriptApplicationSource>> go =
                  ...
                  scope =>
                {
                    ...
                    layout2.GoToLevel3.id = "GoToLevel3";
                    f(0.9);
            ...
            if (page.GoToLevel2 != null)
                page.GoToLevel2.WhenClicked(
                    async button =>
                    {
            ...
            public z(IApp2 page)
            {
                ...
                Action<HistoryScope<InternalScriptApplicationSource>> go =
                      ...
                      scope =>
                    {
                        ...
                        Console.WriteLine("GoToLevel3, eval");
                ...
                if (page.GoToLevel3 != null)
                    page.GoToLevel3.WhenClicked(
                    async button =>
                    {
                        ...
                        Console.WriteLine("GoToLevel3, changing state");
