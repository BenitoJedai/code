...
using TestServiceWorkerFetchHTML;
using TestServiceWorkerFetchHTML.Design;
using TestServiceWorkerFetchHTML.HTML.Pages;
using System.Diagnostics;

namespace TestServiceWorkerFetchHTML
{
    /// <summary>
