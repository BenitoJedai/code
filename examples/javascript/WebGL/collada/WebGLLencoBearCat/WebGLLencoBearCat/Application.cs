...
using WebGLLencoBearCat;
using WebGLLencoBearCat.Design;
using WebGLLencoBearCat.HTML.Pages;
using System.Diagnostics;

namespace WebGLLencoBearCat
{
    /// <summary>
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        public Application(IApp page)
        {
            ...
            new __AssetsLibrary__.ColladaLenco().Source.Task.ContinueWithResult(
                   dae =>
                   {
                       // 90deg
