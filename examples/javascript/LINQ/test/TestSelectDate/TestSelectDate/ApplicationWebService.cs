    ...
    public class ApplicationWebService
    {
        ...
        public void WebMethod2()
        {
            ...
            new Data.PerformanceResourceTimingData2.ApplicationPerformance().Insert(
                ...
                new Data.PerformanceResourceTimingData2ApplicationPerformanceRow { EventTime = DateTime.Now.AddDays(-0.7) },
                new Data.PerformanceResourceTimingData2ApplicationPerformanceRow { EventTime = DateTime.Now.AddDays(-0.3) },
            ...
            var q = from x in new Data.PerformanceResourceTimingData2.ApplicationPerformance()
                        ...
                        // what about files, bytes?

                    select new
                    {
                        // /* QueryStrategyOfTRowExtensions.Select.cs:168 */ select-- diagnostics ,
                        // /* QueryStrategyOfTRowExtensions.Select.cs:417 */      x.`Date` as `Date`
                        //from `PerformanceResourceTimingData2.ApplicationPerformance` as x
                        x.EventTime,

                        x.EventTime.Date,

                        // what about timespans?
                        diff = x.EventTime - x.EventTime.Date
