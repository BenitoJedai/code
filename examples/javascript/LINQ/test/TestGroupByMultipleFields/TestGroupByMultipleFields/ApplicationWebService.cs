...
namespace TestGroupByMultipleFields
{
    ...
    public class ApplicationWebService
    {
        ...
        public void WebMethod2()
        {
            ...
            var z = from y in new Data.PerformanceResourceTimingData2.ApplicationResourcePerformance().AsGenericEnumerable()
                    group new { y } by new { y.duration, y.path } into g
                    select new { g.Key.duration, g.Key.path, Count = g.Count() };

            //var zz = z.AsGenericEnumerable();
