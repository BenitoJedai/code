namespace TestFormsAvalon
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.myContent1 = new TestFormsAvalon.MyContent();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// elementHost1
			// 
			this.elementHost1.Location = new System.Drawing.Point(246, 118);
			this.elementHost1.Name = "elementHost1";
			this.elementHost1.Size = new System.Drawing.Size(287, 101);
			this.elementHost1.TabIndex = 12;
			this.elementHost1.Text = "elementHost1";
			this.elementHost1.Child = this.myContent1;
			// 
			// Form1
			// 
			...
			this.Name = "Form1";
			this.Text = "TestFormsAvalon. Your C# will be converted javascript.";
