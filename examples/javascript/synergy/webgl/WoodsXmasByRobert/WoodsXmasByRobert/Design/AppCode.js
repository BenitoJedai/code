...
function loop() {
    ...
    if (allLoaded) {
        ...
        camera.position.x = (50 * Math.cos(r * 2)) * speedEffector.value;
        camera.position.y = (2 * Math.sin(r * 12) - 100) * speedEffector.value;

        camera.up.x = (Math.sin(r * 12) / 50) * speedEffector.value;
        ...
        var speed = (delta / 2) * speedEffector.value;
        ...
        uniforms.globalTime.value += delta * 0.00015;
