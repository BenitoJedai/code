...
//    logit("plPos " + plPos.x + " " + plPos.y);
    ...
    var maxBorderDist = 10 * GRID_SIZE;
...
function createGround(layer) {
    ...
    var landscapeGeom = new THREE.PlaneGeometry(landscapeChunkWidth * GRID_SIZE, landscapeChunkHeight * GRID_SIZE,
        landscapeChunkWidth-1, landscapeChunkHeight-1);
...
//    var material = GameState.renderer.getGroundMaterial();
    ...
    var texture = new THREE.Texture( generateGroundTexture( layer), new THREE.UVMapping(), THREE.ClampToEdgeWrapping, THREE.ClampToEdgeWrapping );
    texture.needsUpdate = true;

    var material = new THREE.MeshPhongMaterial( { emissive: 0x222222, map: texture } );
