...
namespace HotPolygon.js
{
    ...
    public class HotPolygon
    {
        ...
        private static void Spawn()
        {
            ...
            var img_up = new HTML.Images.FromAssets.up { className = "fx1" };
            var img_up_neg = new HTML.Images.FromAssets.up_neg { className = "fx1" };
            var img_down = new HTML.Images.FromAssets.down { className = "fx1" };
