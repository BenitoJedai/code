...
namespace DraftCTA
{
    ...
    {
        // sdf failed to work with us at this time...
        // in PHP the data will be lost between requests..
        // MSSQL DDL to MySQL to GAE ?
        public static List<string> CallToActionContent = new List<string>();
    }
}
