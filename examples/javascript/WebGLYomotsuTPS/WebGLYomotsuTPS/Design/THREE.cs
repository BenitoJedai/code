...
namespace WebGLYomotsuTPS
{
    ...
    namespace THREE
    {
        ...
        class ImageUtilsModule
        {
            ...
            internal object loadTexture(string p)
            {
                throw new NotImplementedException();
            }
        }
    ...
    namespace THREE
    {
        ...
        sealed class MeshLambertMaterial_map
        {
        ...
        {
            public MeshLambertMaterial_map map;
        ...
        [Script(HasNoPrototype = true, ExternalTarget = "THREE.SphereGeometry")]
        class SphereGeometry
        {
            ...
            public SphereGeometry(int p1, int p2, int p3)
            {
        ...
        class Object3D
        {
            ...
            internal void add(MorphAnimMesh player_mesh)
            {
                throw new NotImplementedException();
            }
        }
        ...
        class Scene
        {
            ...
            internal void add(DirectionalLight light)
            {
                throw new NotImplementedException();
            }
        }
        ...
        class DirectionalLight
        {
            ...
            public DirectionalLight(int p1, double p2)
            {
                // TODO: Complete member initialization
                this.p1 = p1;
                this.p2 = p2;
        ...
        class ProjectionMatrix
        {
            ...
            internal void makePerspective(int fov, int p1, int p2, int p3)
            {
                throw new NotImplementedException();
            }
        }
