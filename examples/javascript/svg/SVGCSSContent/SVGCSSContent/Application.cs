...
namespace SVGCSSContent
{
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        public Application(IApp page)
        {
            ...
            new StockToolboxImageForWebGLComponent().InvokeOnComplete(
                q =>
                {
                    q.src = q.toDataURL();

                    // http://cburgmer.github.io/rasterizeHTML.js/jsconfeu2013/#/step-22

                    // http://stackoverflow.com/questions/20772366/feature-detection-of-absolute-url-images-inside-foreignobject
                    // https://developer.mozilla.org/en/docs/HTML/Canvas/Drawing_DOM_objects_into_a_canvas
                    // Resources such as raster images (such as JPEG images) or <iframe>s have to be inlined as data: URIs.
                    q.AttachTo(divbody);
                }
            );
