...
using HeatZeeker.Audio0.Design;
using HeatZeeker.Audio0.HTML.Pages;
using HeatZeeker.Audio0.HTML.Audio.FromAssets;
using ScriptCoreLib.Shared.Avalon.Tween;

namespace HeatZeeker.Audio0
{
    /// <summary>
    ...
    public sealed class Application
    {
        ...
        public Application(IApp page)
        {
            ...
            var r1 = loop(new helicopter1_speedm10());

            var r2 = loop(new helicopter1_speedm10m10());
