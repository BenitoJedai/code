...
namespace UltraApplicationWithFSharp
{


	public sealed class UltraApplicationWithFSharp
	{

		public UltraApplicationWithFSharp(IHTMLElement e)
		{
			// we are attaching to the DOM now after onload event
			// bootstrap code was generated by jsc.meta and is using ScriptCoreLib

			{
				var x = new IHTMLButton("Invoke");
