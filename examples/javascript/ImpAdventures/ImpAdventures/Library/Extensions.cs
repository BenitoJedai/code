    ...
    static class Extensions
    {
        ...
        public static void SpawnTo<T>(this Type alias, Type[] KnownTypes, Action<T, IHTMLElement> h) where T : class, new()
        {
            ScriptCoreLib.JavaScript.Extensions.Extensions.SpawnTo(
                alias,
                KnownTypes.ToArray(t => Activator.CreateInstance(t))
                ,
                h
            );
        }
        ...
        public static double GetRange(this Point a, Point<double> b)
        {
            var dx = a.X - b.X;
            var dy = a.Y - b.Y;
        ...
        //public static Timer AutoRotate(this Dude2 e, double multiplier)
        //{
        //    return new Timer(
