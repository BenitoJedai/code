...
using TestAndroidCryptoKeyGenerate;
using TestAndroidCryptoKeyGenerate.Design;
using TestAndroidCryptoKeyGenerate.HTML.Pages;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        public Application(IApp page)
        {
                ...
                async btn =>
            {
                ...
                var decrypt = new IHTMLButton { "decrypt " + new { enc.bytes.Length } }.AttachToDocument();
