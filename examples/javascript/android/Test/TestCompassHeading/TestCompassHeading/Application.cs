...
using TestCompassHeading;
using TestCompassHeading.Design;
using TestCompassHeading.HTML.Pages;

namespace TestCompassHeading
{
    /// <summary>
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        {
            // http://people.opera.com/richt/release/tests/orientation/spec_workedexample.html
            ...
            Native.window.ondeviceorientation +=
              dataValues =>
              {
                  ...
                  */
                  ...
                  Native.document.body.innerText = new { lon1, compassHeading, compassHeadingOffset }.ToString();
              };
            #endregion
        }
