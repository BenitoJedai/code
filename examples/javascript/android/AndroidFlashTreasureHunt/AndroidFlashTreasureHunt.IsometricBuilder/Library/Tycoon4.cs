...
using AndroidFlashTreasureHunt.IsometricBuilder.HTML.Images.FromAssets;
using ScriptCoreLib;
...
namespace ThreeDStuff.js
{
    ...
    public partial class Tycoon4
    {
        ...
        public Tycoon4()
        {
            ...
            var TileResources = new
                {
                    ...
                    Tree2 = new { Source = new t2().src, Height = 65 },
                    Tree3 = new { Source = new t3().src, Height = 65 },
            ...
            //var TycoonBusImages = new AndroidFlashTreasureHunt.IsometricBuilder.HTML.Pages.TycoonBus().Images;
            ...
            AllImagesLoaded +=
                delegate
                {
                    ...
                    //CreateNewItemsRandomly(17, TileColorTree2);
                    //CreateNewItemsRandomly(17, TileColorTree3);

                    //CreateNewItemsRandomly(1, TileColorRoad1);
                    ...
                    Timer.DoAsync(
                        delegate
                        {
                            ...
                            SpawnItems(TileColorTree2, () => new t2().src, 65);
                            SpawnItems(TileColorTree3, () => new t3().src, 65);
             ...
             p => Translator.ConvertCanvasToMap(p.ToDouble()).Round().BoundTo(MapSize);
                            ...
                            var IsTree2 = TileResources.Tree2.Source.ToEquals();
                            var IsTree3 = TileResources.Tree3.Source.ToEquals();
                            ...
                            var toolbar_color = Color.FromRGB(0x80, 0x80, 0x80);
                            ...
                            */
                            ...
                            var toolbar_btn_trees3 = new ToolbarButton(
                        toolbar, new t3().src
                     ) { Title = "Build " };
                            ...
                            var TileSelectorModes = new Dictionary<ToolbarButton, TileSelectorMode>
                            {
                                ...
                                {toolbar_btn_trees3, TileSelectorMode.Rectangle},
                            };
                            ...
                            Action<Point<double>, TileSelectorMode> UseCurrentToolAt =
                                (map_coords, CurrentMode) =>
                                {
                                    ...
                                    #region toolbar_btn_trees3
                                    if (toolbar_btn_trees3)
                                    {
                                        Func<string, bool> IsOther = s =>
                                            !(IsGrass(s) || IsTileSelector(s));
                                        ...
                                        if (!Stats.Other)
                                        {
                                            ...
                                            AddTileElement(map_coords, TileResources.Tree3.Source, TileResources.Tree3.Height);
