...
namespace com.abstractatech.consoleworm.js
{
    class Worm
    {
        /*
...
E/GeckoConsole(20811): [JavaScript Warning: "HTTP "Content-Type" of "application/octet-stream" is not supported. Load of media resource http://192.168.1.107:10713/assets/com.abstractatech.consoleworm/applause.mp3 failed." {file: "http://192.168.1.107:10713/" line: 0}]
...
E/AndroidRuntime(20005):        at ScriptCoreLibJava.BCLImplementation.System.Reflection.__MethodInfo.InternalInvoke(__MethodInfo.java:90)
    ...
    public class Game
    {
        ...
        public Game()
        {
            //typeof(com.abstractatech.consoleworm).ToWindowText();
            ...
            new HTML.Images.FromAssets.avatar14683_21().InvokeOnComplete(
                 scull =>
                 {
                     ...
                     var WhenGrowing = new global::com.abstractatech.consoleworm.HTML.Audio.FromAssets.tick();
                     ...
                     100.AtInterval(
                         t =>
                         {
                             ...
                             if (worm.Parts.Any(i => i.Location.IsEqual(worm.NextLocation)))
                             {
                                 ...
                                 AddScore(0);
                                 new global::com.abstractatech.consoleworm.HTML.Audio.FromAssets.buzzer().play();
                             ...
                             if (a.Length > 0)
                             {
                                 ...
                                 WhenGrowing.play();
                                 WhenGrowing = new global::com.abstractatech.consoleworm.HTML.Audio.FromAssets.tick();
                     ...
                     Action<int, int> AtClick =
                         (ev_CursorX, ev_CursorY) =>
                         {
                             if (DisableInput)
                                 return;
                             //DisableInput = true;
                             ...
                             if (ev_CursorX < Native.Window.Width / 2)
                             {
                             ...
                             Console.WriteLine(new { KeyCode }.ToString());
                             ...
                             if (paused)
                             {
                                 ...
                                 AddScore(0);
                                 new global::com.abstractatech.consoleworm.HTML.Audio.FromAssets.reveal().play();
                     ...
                     Native.Document.body.ontouchstart +=
                           (ev) =>
                           {
                               ...
                               AtClick(ev.touches[0].clientX, ev.touches[0].clientY);
                           };
        ...
        //static com.abstractatech.consoleworm()
        //{

        //    typeof(com.abstractatech.consoleworm).SpawnTo(i =>
        //        {
        ...
        //            Timer.DoAsync(
        //                () => new com.abstractatech.consoleworm()
        //            );
        //        });
        //}
