...
namespace SpeakerMusic
{
    ...
    public unsafe class NativeClass1
    {
        ...
        //        1>  Unhandled Exception: System.Reflection.TargetInvocationException: Exception has been thrown by the target of an invocation. ---> System.Exception: opcode handler already set: rem
        //1>     at  .? ? .set_    (OpCode ,     )
        //Unhandled Exception: System.Reflection.TargetInvocationException: Exception has been thrown by the target of an invocation. ---> System.Reflection.TargetInvocationException: Exception has been thrown by the target of an invocation. ---> System.Exception: opcode handler already set: rem
        //   at jsc.Script.CodeInstructionWrapper`1.set_Item(OpCode i, THandler value) in x:\jsc.internal.git\compiler\jsc\Languages\CompilerBase.cs:line 51
