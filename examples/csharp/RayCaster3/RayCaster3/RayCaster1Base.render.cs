        ...
        public void render()
        {
            ...
            for (castColumn = 0; castColumn < PROJECTIONPLANEWIDTH; castColumn += 5)
            {
                ...
                if (distToHorizontalGridBeingHit < distToVerticalGridBeingHit)
                {
                    ...
                    {
                        setColor(GetWallColor(HorizontalGridBeingHit, true));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        setColor(GetWallColor(VerticalGridBeingHit, false));
                    }
                    else
                    {
                ...
                Console.WriteLine("x: " + castColumn + " y: " + topOfWall + " w: " + 5 + " h: " + projectedWallHeight);
