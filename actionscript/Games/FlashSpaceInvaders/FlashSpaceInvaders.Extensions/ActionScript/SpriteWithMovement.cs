            ...
            var t = (1000 / 30).AtInterval(
                delegate
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.x = Math.Max(Math.Min(this.x, this.ClipRectangle.right), this.ClipRectangle.left);
                            this.y = Math.Max(Math.Min(this.y, this.ClipRectangle.bottom), this.ClipRectangle.top);
                        }
