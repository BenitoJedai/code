...
namespace LightsOut.Server
{
    ...
    public class Game : NonobaGame<Player>
    {
        ...
        public override void UserJoined(Player player)
        {
            ...
            player.Virtual = new LightsOut.ActionScript.Shared.Player
            {
                ToOthers =
        ...
        private void Broadcast(LightsOut.ActionScript.Shared.SharedClass1.Messages type, params object[] e)
        {
