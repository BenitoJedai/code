...
call C:\util\flex\bin\mxmlc.exe -keep-as3-metadata -incremental=true -output=%2.swf -strict -sp=. %1/%2.as -include-libraries="assets\ScriptCoreLib.GoogleMaps\map_flex_1_4.swc"
goto :eof