...
namespace ScriptCoreLib.JavaScript.BCLImplementation.System
{
	...
	internal class __Array
	{
		...
		// script: error JSC1000: No implementation found for this native method, please implement [static System.Array.Empty()]
		public static T[] Empty<T>()
		{
			// whats T?
			// is the current calling convention passing typeinfo?
			// or were we baked already?
