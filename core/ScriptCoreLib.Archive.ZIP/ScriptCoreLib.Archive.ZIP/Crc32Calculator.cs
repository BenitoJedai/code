...
namespace ScriptCoreLib.Archive.ZIP
{
	...
	{
		// Fields
		private uint _crc32Value = Crc32StartValue;
		private static uint Crc32StartValue = uint.MaxValue;
		...
		// Methods
		public void ComputeCrc32(byte[] data)
		{
			this._crc32Value = UpdateCRC32(data, this._crc32Value);

		}

		private static uint UpdateCRC32(byte[] data, uint oldCrc)
		{
