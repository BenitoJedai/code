...
using System.Text;
using ScriptCoreLibAppJet.JavaScript.BCLImplementation.System.Reflection;
using ScriptCoreLib;
...
namespace ScriptCoreLibAppJet.JavaScript.BCLImplementation.System
{
    ...
    internal class __Type : __MemberInfo
    {
        ...
        Expando AsExpando()
        {
            return global::ScriptCoreLibAppJet.JavaScript.Runtime.Expando.Of(_TypeHandle.Value);
        }
