...
namespace java.lang
{
	...
	public class Double
	{
		...
		/// format" bit layout.
		/// </summary>
		static public long doubleToLongBits(double @value)
		{
			return default(long);
		}
		...
		/// </summary>
		static public long doubleToRawLongBits(double @value)
		{
			return default(long);
		}
		...
		/// </summary>
		static public bool isInfinite(double @v)
		{
			return default(bool);
		}
		...
		/// </summary>
		static public bool isNaN(double @v)
		{
			return default(bool);
		}
		...
		/// bit representation.
		/// </summary>
		static public double longBitsToDouble(long @bits)
		{
			return default(double);
		}
