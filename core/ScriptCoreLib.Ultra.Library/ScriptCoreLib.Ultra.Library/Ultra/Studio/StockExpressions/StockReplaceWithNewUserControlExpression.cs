...
{
	public class StockReplaceWithNewUserControlExpression : PseudoCallExpression
	{
		public StockReplaceWithNewUserControlExpression(string Namespace, string Name)
		{
			var page_Page1 =
