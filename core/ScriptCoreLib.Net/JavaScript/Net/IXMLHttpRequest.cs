...
namespace ScriptCoreLib.JavaScript.Net
{
    ...
    public class IXMLHttpRequest //: ISink
    {
        ...
        public IXMLHttpRequest(string url, EventHandler<IXMLHttpRequest> handler) { }
        public IXMLHttpRequest(string url, EventHandler<IXMLHttpRequest> handler, bool async) { }
        public IXMLHttpRequest(string url, string data, EventHandler<IXMLHttpRequest> handler) { }
        public IXMLHttpRequest(string url, string data, EventHandler<IXMLHttpRequest> handler, bool async) { }
        public IXMLHttpRequest(string url, IXMLDocument data, EventHandler<IXMLHttpRequest> handler) { }
        public IXMLHttpRequest(string url, IXMLDocument data, EventHandler<IXMLHttpRequest> handler, bool async) { }
        ...
        public IXMLHttpRequest(HTTPMethodEnum method, string url, EventHandler<IXMLHttpRequest> handler) { }
        ...
        private static IXMLHttpRequest InternalConstructor(string url, string data, EventHandler<IXMLHttpRequest> handler)
        {
            return InternalConstructor(url, data, handler, true);
        }

        private static IXMLHttpRequest InternalConstructor(string url, string data, EventHandler<IXMLHttpRequest> handler, bool async)
        {
        ...
        private static IXMLHttpRequest InternalConstructor(string url, EventHandler<IXMLHttpRequest> handler)
        {
        ...
        /// <returns></returns>
        private static IXMLHttpRequest InternalConstructor(string url, EventHandler<IXMLHttpRequest> handler, bool async)
        {
        ...
        /// <param name="async"></param>
        /// <returns></returns>
        private static IXMLHttpRequest InternalConstructor(string url, IXMLDocument data, EventHandler<IXMLHttpRequest> handler, bool async)
        {
            IXMLHttpRequest req = new IXMLHttpRequest(HTTPMethodEnum.POST, url, async);
        ...
        /// <param name="handler"></param>
        /// <returns></returns>
        private static IXMLHttpRequest InternalConstructor(HTTPMethodEnum method, string url, EventHandler<IXMLHttpRequest> handler)
        {
        ...
        [Script(DefineAsStatic = true)]
        public void InvokeOnComplete(EventHandler<IXMLHttpRequest> e, bool async)
        {
            if (e == null)
                return;
        ...
        [Script(DefineAsStatic = true)]
        public void InvokeOnComplete(EventHandler<IXMLHttpRequest> e)
        {
            InvokeOnComplete(e, DefaultInterval);
        }

        [Script(DefineAsStatic = true)]
        public void InvokeOnComplete(EventHandler<IXMLHttpRequest> e, int interval)
        {
            if (e == null)
                return;
