...
namespace ScriptCoreLib.YAML.UnitTest
{
	/// <summary>
	...
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			Debug.Assert(n[0].Field1 == "1");
			Debug.Assert(n[0].Field2 == "2");

			Debug.Assert(n[1].Field1 == "3");
			Debug.Assert(n[1].Field2 == "4");
		}
	}
}
