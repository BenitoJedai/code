...
namespace jsc.meta.Commands.Reference
{
	...
	partial class ReferenceJavaScriptDocument
	{
		...
		private void DefineInstanceLinks(RewriteToAssembly.AssemblyRewriteArguments a, TypeBuilder Page, Dictionary<XElement, MethodBuilder> lookup, MethodAttributes Attributes)
		{
			#region References
			var References = Page.DefineProperty("Anchors", PropertyAttributes.None, typeof(IHTMLAnchor[]), null);

			var References_get = Page.DefineMethod("get_Anchors", Attributes, typeof(IHTMLAnchor[]), null);
