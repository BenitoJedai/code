...
namespace jsc.meta.Commands.Reference
{
	...
	partial class ReferenceJavaScriptDocument
	{
		...
		private void DefineInstanceLinks(RewriteToAssembly.AssemblyRewriteArguments a, TypeBuilder Page, Dictionary<XElement, FieldBuilder> lookup)
		{
			#region References
			var References = Page.DefineProperty("Anchors", PropertyAttributes.None, typeof(IHTMLAnchor[]), null);

			var References_get = Page.DefineMethod("get_Anchors", MethodAttributes.Public | MethodAttributes.Virtual, typeof(IHTMLAnchor[]), null);
...

			{
				...
				Func<IHTMLAnchor[]> Implementation1 = () => new IHTMLAnchor[] { };
