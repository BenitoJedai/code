...
namespace jsc.Languages.Java
{
    ...
    partial class JavaCompiler
    {
        ...
        public void WriteImportTypes(Type z)
        {
            ...
            // see also: http://mindprod.com/jgloss/compileerrormessages.html#DOTEXPECTED
            // see also: http://java.sun.com/docs/books/jls/second_edition/html/packages.doc.html
            // It is a compile time error to import a type from the unnamed package.
            // We could downgrade the consuming classes to unnamed package too.. 
            imports.RemoveAll(k => k.IndexOf(".") < 0);
