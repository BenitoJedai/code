...
namespace jsc.Script.PHP
{
    ...
    partial class PHPCompiler : jsc.Script.CompilerCLike
    {
        ...
        private void WriteDefineAsStaticSelf()
        {
            // PHP does not seem to like when we try to redeclare this?
            Write("$that");
        }
        ...
        public override string GetDecoratedTypeName(Type z, bool bExternalAllowed)
        {
            ...
            var ExternalTarget = z.ToScriptAttributeOrDefault().ExternalTarget;
