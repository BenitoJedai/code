...
namespace jsc
{
        ...
        where T : CommandLineOptionsBase<T>
    {
        ...
        {
            foreach (OptionField v in OptionFields)
            {
                string h = "";
        ...
        readonly OptionField[] OptionFields;
        ...
        {
            OptionFields = OptionField.Of((T)this);
        ...
        public class OptionField 
        {
            ...
            public static OptionField[] Of<TArg>(TArg target)
            {
                return Of(target, typeof(TArg).GetFields());
            }

            public static OptionField[] Of(object target, FieldInfo[] e)
            {
                List<OptionField> a = new List<OptionField>();
