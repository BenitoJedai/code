...
public final class Context{
	...
	//System.err.println("Context.ListReaders(group): cnt " + ((sa == null) ? 0 : sa.length));
	...
	//System.err.println("Context.ListGroups(): cnt " + ((sa == null) ? 0 : sa.length));

	if (sa == null) return emptyStringArray;

	//for (int i = 0; i < sa.length; i++)
	    //System.err.println("Group " + i + ": " + sa[i]);
	...
	//System.out.println("Context.WaitForCard(): calling first time GetStatusChange() ...\n");

	GetStatusChange(0, states);

	//System.out.println("Context.WaitForCard(): calling second time GetStatusChange() ...\n");
	...
	//System.out.println("Context.Connect(): rdr " + szReader);
    ...
    //System.out.println("Context.Connect(): rdr " + szReader + ", share " + dwShareMode + ", " + c);
